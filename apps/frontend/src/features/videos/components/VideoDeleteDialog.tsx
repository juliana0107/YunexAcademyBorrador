      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        <div className="flex items-start gap-4 p-6">
          ...
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-gray-900 mb-1">Eliminar video</h3>
            <p className="text-sm text-gray-600">
              ¿Estás seguro de que quieres eliminar <strong>{videoTitle}</strong>? Esta
              acción no se puede deshacer y el archivo se borrará del servidor.
            </p>
          </div>
          <button
            onClick={onCancel}
